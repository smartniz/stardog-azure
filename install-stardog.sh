...
echo "export STARDOG_SERVER_JAVA_ARGS='-Dstardog.license.trial.auto.download.email=$1 -Dstardog.license.server=https://reginaldtestingblue.stardog.com/lic'" | sudo tee -a /etc/stardog.env.sh
